    ...
    <div class="flex flex-col lg:flex-row border-t-[2px] min-h-[calc(100vh-4rem)] bg-slate-900 pb-[100px] md:pb-0">
        ...
        <aside class="desktop-sidebar w-20 sm:w-72 text-white lg:h-[calc(100vh-4rem)] border-r-[2px] border-gray-50">
            ...
            <nav class="p-4 space-y-2 sm:static">
                ...
                class="flex items-center px-4 py-2 rounded hover:bg-gray-700 {{ request()->routeIs('employe.calendrier') ? 'active-nav' : '' }}">
                    ...
                    <span class="ml-3 hidden sm:block">Pointage</span>
                </a>

                <!-- Mes présences -->
                <a href="{{ route('employe.mes_presences') }}" 
                class="flex items-center px-4 py-2 rounded hover:bg-gray-700 {{ request()->routeIs('employe.mes_presences') ? 'active-nav' : '' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
        ...
        <nav class="mobile-bottom-nav lg:hidden">
            ...
            <!-- Pointage - Menu Mobile -->
            <a href="{{ route('employe.calendrier') }}" 
            class="flex flex-col items-center {{ request()->routeIs('employe.calendrier') ? 'active' : '' }}">
            ...
            <!-- Mes présences - Menu Mobile -->
            <a href="{{ route('employe.mes_presences') }}" 
            class="flex flex-col items-center {{ request()->routeIs('employe.mes_presences') ? 'active' : '' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                </svg>
                <span>Présences</span>
