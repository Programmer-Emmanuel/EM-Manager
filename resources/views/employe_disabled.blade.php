...
<head>
    ...
    <title>Accès Employé - EM-Manager</title>
...
<body class="h-full flex items-center justify-center p-4">
    <div class="error-card rounded-xl p-8 max-w-md w-full mx-4 text-center">
        ...
        <h1 class="text-2xl md:text-3xl font-bold text-white mb-4">Compte desactivé</h1>
        
        <p class="text-slate-300 mb-8">
            Entreprise désactivé.
            Le compte de votre entreprise a été desactivé. Veuillez prévenir votre Directeur afin d’avoir accès à nouveau à votre espace.
        </p>
