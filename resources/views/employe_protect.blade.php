...
<head>
    ...
    <title>404 Employé - EM-Manager</title>
...
<body class="bg-gray-100 flex justify-center items-center h-screen">
    ...
    <div class="bg-slate-900 text-white p-8 rounded-lg shadow-lg max-w-md w-full mx-[15px]">
        <div class="flex items-center mb-4">
            ...
            <h2 class="text-2xl font-semibold">Cette page est destinée uniquement à un employé</h2>
        </div>
        <p class="mb-6">Si vous n'êtes pas un employé, connectez vous ou veuillez revenir à la page précédente.</p>
