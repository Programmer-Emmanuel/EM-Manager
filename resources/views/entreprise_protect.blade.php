...
<body class="h-full flex items-center justify-center p-4">
    <div class="error-card rounded-xl p-8 max-w-md w-full mx-4 text-center">
        ...
        <h1 class="text-2xl md:text-3xl font-bold text-white mb-4">Accès réservé aux entreprises</h1>
        
        <p class="text-slate-300 mb-8">
            Cette section est exclusivement réservée aux comptes entreprise. 
        ...
        <div class="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="{{route('login')}}" class="bg-slate-900 hover:bg-slate-950 text-white font-medium py-3 px-6 rounded-lg">
                <i class="fas fa-sign-in-alt mr-2"></i> Connexion Entreprise
            </a>
        </div>
        ...
        <div class="mt-8 pt-6 border-t border-slate-700">
            <p class="text-slate-400 text-sm">
                ...
                <a href="{{route('register')}}" class="text-blue-400 hover:text-blue-300">Enregistrez votre entreprise</a>
            </p>
        </div>
    </div>
