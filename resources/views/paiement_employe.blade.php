...
<main class="flex-1 overflow-hidden relative bg-slate-900">
    ...
    <!-- Modal confirmation optimisée mobile avec scroll -->
    ...
    <!-- Effets décoratifs -->
    <div class="absolute -bottom-32 -left-32 w-64 h-64 bg-blue-500 rounded-full mix-blend-multiply filter blur-3xl opacity-5"></div>
    <div class="absolute -top-32 -right-32 w-64 h-64 bg-cyan-500 rounded-full mix-blend-multiply filter blur-3xl opacity-5"></div>
...
function lancerPaiement() {
    ...
    btn.disabled = true;
    btnText.innerHTML = '<i class="fas fa-spinner fa-spin mr-2"></i> Traitement...';
    
    // Initialiser KkiaPay
    const kkiapay = new KkiapayWidget('42158a40c9ef11f0b284d131c761bd2b', {
...
// Initialiser les tooltips et améliorations
document.addEventListener('DOMContentLoaded', function() {
    ...
    style.textContent = `
        ...
        /* Animation pour l'apparition des cartes employés */
        .grid > div {
